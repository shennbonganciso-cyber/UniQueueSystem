...
export function QueueMonitoring() {
  ...
  const [nextNumbers, setNextNumbers] = useState([39, 40, 42]);
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-7xl space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            {nextNumbers.map((num, idx) => (
              <div key={num} className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-2xl p-4 border border-white/10 text-center shadow-xl">
