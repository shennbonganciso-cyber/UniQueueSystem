...
export function ReportsPage() {
  ...
  const dailyData = [
    { day: "Mon", patients: 45, avgWait: 6 },
    { day: "Tue", patients: 52, avgWait: 7 },
    { day: "Wed", patients: 48, avgWait: 5 },
    { day: "Thu", patients: 61, avgWait: 8 },
    { day: "Fri", patients: 55, avgWait: 6 },
  ];

  const serviceData = [
    { service: "Consultation", count: 156, percentage: 65 },
    { service: "Medical Cert", count: 52, percentage: 22 },
    { service: "Excuse Slip", count: 31, percentage: 13 },
  ];

  const recentTransactions = [
    { id: 1, queue: 38, service: "Consultation", time: "09:15 AM", wait: "5m", status: "Completed" },
    { id: 2, queue: 39, service: "Medical Certificate", time: "09:28 AM", wait: "3m", status: "Completed" },
    { id: 3, queue: 40, service: "Consultation", time: "09:45 AM", wait: "7m", status: "Completed" },
    { id: 4, queue: 42, service: "Excuse Slip", time: "10:02 AM", wait: "4m", status: "Completed" },
    { id: 5, queue: 43, service: "Consultation", time: "10:18 AM", wait: "6m", status: "Completed" },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          <div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-2xl p-4 border border-white/10">
            ...
            <p className="text-2xl mb-2 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">261</p>
          ...
          <div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-2xl p-4 border border-white/10">
            ...
            <p className="text-2xl mb-2 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">6.4m</p>
          ...
          <div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-2xl p-4 border border-white/10">
            ...
            <p className="text-2xl mb-2 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">9-11 AM</p>
            <div className="flex items-center gap-2 text-slate-400 text-xs">
              <Activity className="w-4 h-4" />
              <span>Busy period</span>
            </div>
          </div>
          <div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-2xl p-4 border border-white/10">
            <p className="text-xs text-slate-400 mb-2">Completion Rate</p>
            <p className="text-2xl mb-2 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">94%</p>
            <div className="flex items-center gap-2 text-emerald-400 text-xs">
              <TrendingUp className="w-4 h-4" />
              <span>+3%</span>
            </div>
                ...
                <tbody>
                  {recentTransactions.map((tx) => (
                    <tr key={tx.id} className="border-b border-white/5 last:border-0 hover:bg-white/5 transition-colors">
                      <td className="py-2.5 text-sm">{tx.queue}</td>
                      <td className="py-2.5 text-sm">{tx.service}</td>
                      <td className="py-2.5 text-sm text-slate-400">{tx.time}</td>
                      <td className="py-2.5 text-sm text-slate-400">{tx.wait}</td>
                      <td className="py-2.5">
